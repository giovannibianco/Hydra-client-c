...
void print_usage_and_die(FILE * out){
    ...
    fprintf (out, "usage: %s <localfilename> <remotefilename> <surl> <outfilename>\n", PROGNAME);
...
int main(int argc, char **argv)
{
  ...
  in = argv[1]; remote = argv[2]; surl = argv[3]; out = argv[4];
  ...
  if (NULL == (ectx = glite_eds_register_encrypt_init(remote, surl,
						      NULL, &error)))
    {
